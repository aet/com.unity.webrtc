...
extern "C"
{
    ...
    UNITY_INTERFACE_EXPORT void ReceiverSetTransform(
        RtpReceiverInterface* receiver, FrameTransformerInterface* transformer)
    {
    ...
    UNITY_INTERFACE_EXPORT uint32_t FrameGetTimestamp(
        TransformableFrameInterface* frame)
    {
        return frame->GetTimestamp();
    }

    UNITY_INTERFACE_EXPORT uint32_t FrameGetSsrc(
        TransformableFrameInterface* frame)
    {
        return frame->GetSsrc();
    }

    UNITY_INTERFACE_EXPORT bool VideoFrameIsKeyFrame(
        TransformableVideoFrameInterface* frame, bool* isKeyFrame)
    {
